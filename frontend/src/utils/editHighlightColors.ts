...
// `accent` (the 500 shade) feeds the --edit-accent CSS variable that recolors
// focused text boxes inside .edit-accent-scope containers (see index.css).
export const EDIT_HIGHLIGHT_COLORS: Record<string, { form: string; cardRing: string; cardBorderColor: string; accent: string }> = {
  emerald: {
